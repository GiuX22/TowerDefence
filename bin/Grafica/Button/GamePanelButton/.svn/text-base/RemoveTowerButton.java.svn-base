...
public class RemoveTowerButton extends JButton{
	private int height;
	private int width;
	private MainFrame mainFrame;
	private ImageIcon icon;

	public RemoveTowerButton(String nameButton,int x,int y,int width,int height,MainFrame mainFrame) {
		this.height=height;
		this.width=width;
		this.mainFrame=mainFrame;
		icon=new ImageIcon(getImage("remove.png").getScaledInstance(width,height, java.awt.Image.SCALE_SMOOTH));
		setIcon(icon);
		setName(nameButton);
