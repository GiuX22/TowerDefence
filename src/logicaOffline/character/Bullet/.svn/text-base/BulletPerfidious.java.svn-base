...
public class BulletPerfidious extends AbstractBullet{
	public BulletPerfidious(double x,double y,AbstractTower tower) {
		super(x, y,tower);
		speed=0.08;
		damage=80;
	...
	public BulletPerfidious(double x, double y, AbstractTower Tower,double powerBullet) {
		super(x, y, Tower);
		speed=0.08;
	...
	public void update() {
		...
		if(this.life)
		{
			...
			if(lifeMonster <=0 && (tower.getMonsterTarget() instanceof PerfidiousBoss))
			{
