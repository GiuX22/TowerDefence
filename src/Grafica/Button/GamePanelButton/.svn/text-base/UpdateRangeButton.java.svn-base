...
public class UpdateRangeButton extends JButton{
	private int height;
	private int width;
	private MainFrame mainFrame;
	private ImageIcon icon;

	public UpdateRangeButton(String nameButton,int x,int y,int width,int height,MainFrame mainFrame) {
		this.height=height;
		this.width=width;
		this.mainFrame=mainFrame;
		icon=new ImageIcon(getImage("updateRange.png").getScaledInstance(width,height, java.awt.Image.SCALE_SMOOTH));
		setIcon(icon);
		setName(nameButton);
